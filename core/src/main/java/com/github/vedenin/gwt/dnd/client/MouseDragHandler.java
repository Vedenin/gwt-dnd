...
import com.github.vedenin.gwt.dnd.client.util.Location;
import com.github.vedenin.gwt.dnd.client.util.WidgetLocation;
  ...
  void makeDraggable(Widget draggable, Widget dragHandle) {
    if (draggable instanceof PopupPanel) {
      DOMUtil.reportFatalAndThrowRuntimeException(
          "PopupPanel (and its subclasses) cannot be made draggable; See https://github.com/fredsa/gwt_dnd/issues/43");
    }
    try {
