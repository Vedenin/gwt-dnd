 ...
 * the License.
 */
package com.github.vedenin.gwt.dnd.demo.client.example;
...
public abstract class Example extends SimplePanel {
  ...
  /**
   * Convenience method to create a default draggable widget. The widget is automatically made
   * draggable by calling {@link DragController#makeDraggable(Widget)}.
   * 
