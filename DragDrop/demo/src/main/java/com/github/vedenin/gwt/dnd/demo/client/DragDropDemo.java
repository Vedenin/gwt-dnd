...
import com.github.vedenin.gwt.dnd.client.drop.BoundaryDropController;
import com.github.vedenin.gwt.dnd.demo.client.example.DraggableFactory;
import com.github.vedenin.gwt.dnd.demo.client.example.absolute.AbsolutePositionExample;
import com.github.vedenin.gwt.dnd.demo.client.example.bin.BinExample;
import com.github.vedenin.gwt.dnd.demo.client.example.clicktouch.ClickTouchExample;
import com.github.vedenin.gwt.dnd.demo.client.example.draghandle.DragHandleExample;
import com.github.vedenin.gwt.dnd.demo.client.example.duallist.DualListExample;
import com.github.vedenin.gwt.dnd.demo.client.example.flextable.FlexTableRowExample;
import com.github.vedenin.gwt.dnd.demo.client.example.flowpanel.FlowPanelExample;
import com.github.vedenin.gwt.dnd.demo.client.example.grid.GridConstrainedExample;
import com.github.vedenin.gwt.dnd.demo.client.example.insertpanel.InsertPanelExample;
import com.github.vedenin.gwt.dnd.demo.client.example.matryoshka.MatryoshkaExample;
import com.github.vedenin.gwt.dnd.demo.client.example.palette.PaletteExample;
import com.github.vedenin.gwt.dnd.demo.client.example.puzzle.PuzzleExample;
import com.github.vedenin.gwt.dnd.demo.client.example.resetcache.ResetCacheExample;
import com.github.vedenin.gwt.dnd.demo.client.example.window.WindowExample;
...
/**
 * EntryPoint class for demonstrating and testing gwt_dnd.
 */
public final class DragDropDemo implements EntryPoint {
  ...
  private void onModuleLoad2() {
    ...
    mainPanel.add(new HTML(
        "<div style='font-weight: bold; font-size: 1.2em;'><a href='https://github.com/fredsa/gwt_dnd'>gwt_dnd</a>" + " - Drag-and-Drop for your Google Web Toolkit projects.</div>" + "<div style='font-style: italic; margin-bottom: 1em;'>by Fred Sauer</div>"));
    ...
    mainPanel.add(new HTML(
        "<div style='color: gray; margin-top: 1em;'>Demo created with gwt_dnd 4.0 and GWT " + GWT.getVersion() + "</div>"));
