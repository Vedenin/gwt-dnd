...
import com.github.vedenin.gwt.dnd.client.util.StringUtil;
...
import com.github.vedenin.gwt.dnd.demo.client.ui.MultiRowTabPanel;
import com.github.vedenin.gwt.dnd.demo.client.util.GWTUtil;
...
/*
 * * {@link MultiRowTabPanel} which uses a {@link VerticalPanel} to provide a description for each
 * example.
 */
public final class ExampleTabPanel extends MultiRowTabPanel {
   ...
   * {@link DropController} used in the example.
   * 
