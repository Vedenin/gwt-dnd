 ...
 * the License.
 */
package com.github.vedenin.gwt.dnd.client.util;

import com.github.vedenin.gwt.dnd.client.util.impl.DOMUtilImpl;
...
public class DOMUtil {
   ...
   * 
   * TODO Change IndexedPanel to InsertPanel
   * 
